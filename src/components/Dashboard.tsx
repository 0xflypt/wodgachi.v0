  ...
  return (
    ...
    >
      <div className={`relative w-[95vw] h-[90vh] max-w-6xl rounded-2xl shadow-2xl border-4 overflow-hidden ${
        isDarkMode 
          ? 'bg-gradient-to-br from-red-900 via-red-800 to-gray-900 border-red-500'
      ...
      >
        ...
        <button
          ...
          className={`absolute top-4 right-4 z-50 p-3 rounded-full transition-all duration-200 hover:scale-110 active:scale-95 shadow-lg ${
            isDarkMode 
              ? 'bg-red-600 hover:bg-red-700 text-yellow-200 hover:text-yellow-100 border-2 border-red-400'
        ...
        <div className="relative z-10 h-full flex flex-col p-6">
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className={`rounded-xl p-6 border-2 relative overflow-hidden ${
              isDarkMode 
                ? 'bg-gradient-to-br from-red-800/90 to-red-900/90 border-red-600'
              ...
              <div className="flex justify-center items-center h-64 mb-4 relative">
                {getWorkoutMedia() ? (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 hover:opacity-100 transition-opacity duration-200">
                        <button
                          ...
                          className={`p-4 rounded-full ${
                            isDarkMode 
                              ? 'bg-purple-600/80 hover:bg-purple-700/80 text-yellow-200'
                  ...
                  <div className={`w-48 h-48 rounded-full flex items-center justify-center text-8xl transition-all duration-500 ${
                    isDarkMode 
                      ? 'bg-gradient-to-br from-red-600/30 to-red-800/30 border-4 border-red-500/50'
                  ...
                  <div className="w-52 h-52 rounded-full border-4 border-transparent relative">
                    <div 
                      className={`absolute inset-0 rounded-full border-4 border-transparent transition-all duration-100 ${
                        isDarkMode ? 'border-t-purple-400' : 'border-t-gray-600'
                      }`}
                      style={{ 
                        transform: `rotate(${(progress / 100) * 360}deg)`,
                        borderTopColor: isDarkMode ? '#dc2626' : '#4b5563'
                      }}
                    ></div>
                  </div>
                  </div>
            ...
            <div className="space-y-4">
              ...
              <div className={`rounded-xl p-4 border-2 ${
                isDarkMode 
                  ? 'bg-gradient-to-br from-gray-800/90 to-purple-900/90 border-purple-600'
                  : 'bg-gradient-to-br from-gray-50/90 to-yellow-50/90 border-gray-400'
              }`}>
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  {exercise.sets && (
                    <div className={`p-3 rounded-lg border ${
                      ...
                      <div className="flex items-center space-x-2">
                        <Zap className={`h-4 w-4 ${isDarkMode ? 'text-purple-400' : 'text-gray-500'}`} />
                        <span className={`text-sm font-bold ${
                          isDarkMode ? 'text-yellow-200' : 'text-gray-800'
                  ...
                  {exercise.reps && (
                    <div className={`p-3 rounded-lg border ${
                      ...
                      <div className="flex items-center space-x-2">
                        <Target className={`h-4 w-4 ${isDarkMode ? 'text-purple-400' : 'text-gray-500'}`} />
                        <span className={`text-sm font-bold ${
                          isDarkMode ? 'text-yellow-200' : 'text-gray-800'
                  ...
                  {exercise.duration && (
                    <div className={`p-3 rounded-lg border ${
                      ...
                      <div className="flex items-center space-x-2">
                        <Clock className={`h-4 w-4 ${isDarkMode ? 'text-purple-400' : 'text-gray-500'}`} />
                        <span className={`text-sm font-bold ${
                          isDarkMode ? 'text-yellow-200' : 'text-gray-800'
                  ...
                  {exercise.rest && (
                    <div className={`p-3 rounded-lg border ${
                      ...
                      <div className="flex items-center space-x-2">
                        <Heart className={`h-4 w-4 ${isDarkMode ? 'text-purple-400' : 'text-gray-500'}`} />
                        <span className={`text-sm font-bold ${
                          isDarkMode ? 'text-yellow-200' : 'text-gray-800'
                ...
                <div className="flex items-center justify-center space-x-4">
                  <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 active:scale-95 ${
                      isDarkMode 
                        ? 'bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900 text-yellow-200 hover:text-yellow-100'
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 active:scale-95 ${
                      isDarkMode 
                        ? 'bg-gradient-to-r from-purple-500 to-purple-700 hover:from-purple-600 hover:to-purple-800 text-yellow-200 hover:text-yellow-100'
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 active:scale-95 ${
                      isDarkMode 
                        ? 'bg-gradient-to-r from-purple-400 to-purple-600 hover:from-purple-500 hover:to-purple-700 text-yellow-200 hover:text-yellow-100'
          ...
          <div className={`mt-6 p-4 rounded-xl border-2 text-center ${
            isDarkMode 
              ? 'bg-gradient-to-r from-purple-800/90 to-gray-800/90 border-purple-600'
